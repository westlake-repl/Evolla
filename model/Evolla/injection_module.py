...
class CrossAttention(nn.Module):
    def __init__(
        ...
        num_attention_heads,
        hidden_size,
        protein_encoder_dim=None,  # protein dim in fusion module
        structure_encoder_dim=None,  # structure dim in fusion module
        msa_encoder_dim=None,  # msa dim in fusion module
        ffn_mult=None,
        ...
        self.out_proj = nn.Linear(hidden_size, hidden_size, bias=enable_bias)

        self.ff = FeedForward(hidden_size, ffn_mult)
...
#             text_time = media_locations.cumsum(
#                 dim=-1
